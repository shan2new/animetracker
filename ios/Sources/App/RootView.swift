...
enum AppTab: Int, CaseIterable, Hashable {
    ...
    /// The SF Symbol for a tab drawn from the system set rather than the Hugeicons catalogue.
    var systemImage: String? { self == .discover ? "sparkle.magnifyingglass" : nil }
    ...
    var body: some View {
        ZStack(alignment: .bottom) {
            TabView(selection: selection) {
                ...
                Tab(AppTab.discover.titleKey, systemImage: AppTab.discover.systemImage ?? "magnifyingglass",
                    value: AppTab.discover) {
